...
import ValidadorCpfCnpj from './functions/ValidadorCpfCnpj';


function Cadastro() {

  //VALIDADOR DE CPF 
  const { valor, handleInputChange } = ValidadorCpfCnpj();
  ...
  const SeuComponenteComInput = () => {
    const handleInputChange = (event) => {
      // Lógica a ser executada quando o input do CPF é alterado
      console.log('Input alterado:', event.target.value);
    };

    const handleInputBlur = () => {
      // Lógica a ser executada quando o input do CPF perde o foco
            ...
            <div className="col-8 offset-2">
              <form onSubmit={handleSubmit}>
                ...
                <div className="form-floating mb-3">
                  ...
                  <input type="text" className="form-control" id="cpf" placeholder='Digite seu CPF' required onChange={handleInputChange} valor={valor} />
